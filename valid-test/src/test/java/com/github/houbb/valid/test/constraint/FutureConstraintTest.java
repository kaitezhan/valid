...
public class FutureConstraintTest {
    ...
    public void passTest() {
        ...
        IResult result = ValidBs.newInstance().on(testDate, Constraints.futureConstraint())
            .result();
    ...
    public void passInclusiveTest() {
        Date testDate = DateUtil.getFormatDate("90120101", DateUtil.PURE_DATE_FORMAT);
        IResult result = ValidBs.newInstance().on(testDate, Constraints.futureConstraint(new Date()))
                .result();
        Assert.assertTrue(result.pass());
        System.out.println(result);
    }
    ...
    public void passNullTest() {
        IResult result = ValidBs.newInstance().on(null, Constraints.futureConstraint(new Date()))
                .result();
        Assert.assertTrue(result.pass());
        System.out.println(result);
    }
    ...
    public void unSupportClassTypeTest() {
        IResult result = ValidBs.newInstance().on(123, Constraints.futureConstraint())
                .result();
        Assert.assertFalse(result.pass());
        System.out.println(result);
    }
